        ...
        <div className="bg-[#F9A82510] border border-[#F9A82530] rounded-xl p-3 mb-6">
          <div className="flex items-start gap-2">
            ...
            <p className="text-[#F9A825] text-xs">
              Your withdrawal address can only be changed once every 24 hours.
              Double-check the address before saving — wrong address = permanent
              loss.
            </p>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="card border-[#00C85330] bg-[#00C85508]">
            ...
            <p className="text-[#888] text-[11px]">
              Only send USDT ({network}) to this address. Sending other tokens
